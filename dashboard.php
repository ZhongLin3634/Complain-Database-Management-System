...
?>
    ...
    <div class="container">
        <div class = "sidebar">
            ...
            <a href="UserProfile.php?user_id=<?php echo $userId; ?>" class="sidelink <?php if ($currentPage == 'dashboard.php') echo 'currentlink'; ?>">UserProfile</a><br>
            <a href="register_user.php" class="sidelink <?php if ($currentPage == 'dashboard.php') echo 'currentlink'; ?>">Registration</a><br>
        </div>
